...
def parse_options():
    ...
    parser.add_argument(
        "--cpu", action="store_true", help="Build with cpu image."
    )
    parser.add_argument(
        "--gpu", action="store_true", help="Build with gpu image."
    )
    parser.add_argument(
        "--cxx-compiler",
        default="default",
...
def build(options):
    ...
    subprocess.check_call(
        ["cmake", SEARCH_DIR, "-DCMAKE_BUILD_TYPE=" + BUILD_TYPE]
        + extra_options,
