...
def parse_options():
    ...
    parser.add_argument('--cpu', dest='cpu', action='store_true', help='Run planner in cpu mode.')
    parser.add_argument('--gpu', dest='gpu', action='store_true', help='Run planner in gpu mode.')
