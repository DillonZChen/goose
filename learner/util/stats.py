""" Module containing methods originally used in thesis inference experiments. """
import numpy as np
...
def print_quartiles(desc: str, data: np.array, floats: bool = False):
    ...
    if floats:
        print(
            f"{desc:<20} {q1:>10.3f} {q2:>10.3f} {q3:>10.3f} {min(data):>10.3f} {max(data):>10.3f}"
        )
    else:
        data = np.round(data).astype(int)
        print(
            f"{desc:<20} {q1:>10} {q2:>10} {q3:>10} {min(data):>10} {max(data):>10}"
        )
