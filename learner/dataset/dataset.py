...
ROOT_DIR = f"{CUR_DIR}/../.."
_DOWNWARD = f"{ROOT_DIR}/planners/downward/fast-downward.py"
_POWERLIFTED = f"{ROOT_DIR}/planners/powerlifted/powerlifted.py"
_BENCHMARKS_DIR = f"{ROOT_DIR}/dataset"  # assume script called from learner directory
