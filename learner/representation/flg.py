...
class FdrLearningGraph(Representation, ABC):
    ...
    def _compute_graph_representation(self) -> None:
        ...
        for (
            var,
            val,
        ) in self.problem.varval_to_fact:  # see planning.representations.FDRProblem
        ...
        for var in variables:
            ...
            for val in variables[var]:
                ...
                G.add_edge(
                    u_of_edge=var,
                    v_of_edge=val_node,
                    edge_label=FLG_EDGE_LABELS.VV_EDGE.value,
                )
        ...
        for action in self.problem.actions:
            ...
            for (
                var,
                val,
            ) in action.add_effects:  # from our compilation, effects are in add only
