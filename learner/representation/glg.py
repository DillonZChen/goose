    ...
    def _compute_graph_representation(self) -> None:
        ...
        for action in actions:
            ...
            G.add_edge(
                u_of_edge=a_node,
                v_of_edge=s_node,
                edge_label=GLG_EDGE_LABELS.PREDICATE.value,
            )
            ...
            for proposition in action.precondition:
                ...
                G.add_edge(
                    u_of_edge=p_node,
                    v_of_edge=a_node,
                    edge_label=GLG_EDGE_LABELS.PRE_EDGE.value,
                )
            for _, proposition in action.add_effects:  # ignoring conditional effects
                ...
                G.add_edge(
                    u_of_edge=p_node,
                    v_of_edge=a_node,
                    edge_label=GLG_EDGE_LABELS.ADD_EDGE.value,
                )
            for _, proposition in action.del_effects:  # ignoring conditional effects
                ...
                G.add_edge(
                    u_of_edge=p_node,
                    v_of_edge=a_node,
                    edge_label=GLG_EDGE_LABELS.DEL_EDGE.value,
                )
