...
class Representation(ABC):
    ...
    def __init__(self, domain_pddl: str, problem_pddl: str) -> None:
        ...
        self.problem = get_planning_problem(
            domain_pddl=self.domain_pddl, problem_pddl=self.problem_pddl, fdr=self.name == "flg"
        )
    ...
    def str_to_state(self, state):
        """Converts set of pyperplan facts to input of a graph representation
        Defaults to doing nothing. Lifted graphs split facts into predicate argument tuples
        """
        return state
