...
def main():
    ...
    parser.add_argument("--clear-cache", action="store_true", help="Remove intermediate images.")
    ...
    INTERMEDIATE_DEF = f"{CUR_DIR}/goose-base{suffix}.def"
    INTERMEDIATE_SIF = f"{CUR_DIR}/goose-base{suffix}.sif"
