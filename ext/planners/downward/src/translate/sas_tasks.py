...
class SASVariables:
    def __init__(self, ranges: List[int], axiom_layers: List[int], value_names: List[List[str]]) -> None:
        self.ranges = ranges
...
class SASOperator:
    def __init__(
        self, name: str, prevail: List[VarValPair], pre_post: List[Tuple[int, int, int, List[VarValPair]]], cost: int
    ) -> None:
        self.name = name
