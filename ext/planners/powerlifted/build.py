...
def parse_options():
    parser = argparse.ArgumentParser(
        formatter_class=argparse.ArgumentDefaultsHelpFormatter, description="Build Power Lifted planner."
    )
...
def build(debug_flag, compiler):
    ...
    subprocess.check_call(
        ["cmake", SEARCH_DIR, "-DCMAKE_BUILD_TYPE=" + BUILD_TYPE] + extra_options, cwd=BUILD_SEARCH_DIR
    )
