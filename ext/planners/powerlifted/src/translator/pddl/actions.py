...
class Action(object):
    ...
    def get_action_preconditions(self):
        ...
        try:
            ...
            raise NotImplementedError("Preconditions must be a single atom or a conjunction of " "atoms.")
        return precond
    ...
    def get_literals_in_effects(self):
        ...
        for eff in self.effects:
            try:
                ...
                raise NotImplementedError("Conditional effects are not supported.")
