...
ALIASES["seq-sat-fd-autotune-1"] = [
    ...
    "--heuristic",
    "hcea=cea(cost_type=normal)",
    "--heuristic",
    "hcg=cg(cost_type=plusone)",
    "--heuristic",
    "hgc=goalcount(cost_type=normal)",
    "--heuristic",
    "hAdd=add(cost_type=normal)",
    "--search",
    """iterated([
...
ALIASES["seq-sat-fd-autotune-2"] = [
    "--heuristic",
    "hcea=cea(cost_type=plusone)",
    "--heuristic",
    "hcg=cg(cost_type=one)",
    "--heuristic",
    "hgc=goalcount(cost_type=plusone)",
    "--heuristic",
    "hff=ff(cost_type=normal)",
    "--search",
    """iterated([
