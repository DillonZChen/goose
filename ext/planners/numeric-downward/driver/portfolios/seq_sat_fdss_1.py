...
CONFIGS = [
    ...
    (
        ...
        [
            "--heuristic",
            "hcea=cea(cost_type=H_COST_TYPE)",
            "--heuristic",
            "hcg=cg(cost_type=H_COST_TYPE)",
            "--search",
    ...
    (
        ...
        [
            ...
            "hff=ff(cost_type=H_COST_TYPE)",
            "--heuristic",
            "hadd=add(cost_type=H_COST_TYPE)",
            "--search",
