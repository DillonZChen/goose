#ifndef OPERATOR_COUNTING_DELETE_TEST_CONSTRAINTS_H
#define OPERATOR_COUNTING_DELETE_TEST_CONSTRAINTS_H
...
namespace operator_counting {
    ...
    class DeleteTestConstraints : public ConstraintGenerator {
        ...
        void add_actions_constraints(std::vector<lp::LPConstraint> &constraints, double infinity);
        void add_initial_state_constraints(std::vector<lp::LPConstraint> &constraints);
        void add_goal_state_constraints(std::vector<lp::LPConstraint> &constraints, TaskProxy &task_proxy);
        void add_preconditions_constraints(std::vector<lp::LPConstraint> &constraints, double infinity);
        void add_preconditions_constraints_inv(std::vector<lp::LPConstraint> &constraints, double infinity);

        void add_effects_constraints(std::vector<lp::LPConstraint> &constraints, double infinity);
        void add_sequencing_constraints(std::vector<lp::LPConstraint> &constraints, double infinity);
        void add_numeric_conditions_constraints(std::vector<lp::LPConstraint> &constraints, double infinity);
        void add_numeric_preconditions_constraints(std::vector<lp::LPConstraint> &constraints, double infinity);
        void add_numeric_goals_constraints(std::vector<lp::LPConstraint> &constraints);
        void add_numeric_effects_constraints(std::vector<lp::LPConstraint> &constraints, double infinity);
        void add_numeric_counters_constraints(std::vector<lp::LPConstraint> &constraints, double infinity);
        void add_numeric_sequencing_constraints(std::vector<lp::LPConstraint> &constraints, double infinity);

        void iterative_variable_elimination(const State &state, vector<bool> &fact_eliminated, vector<bool> &action_eliminated);

        void inverse_action_detection();

        bool set_include(set<int> &first, set<int> &second);

        // update fact and action eliminated, return true if something is change, false if not;
        ...
        vector<set<int>> inverse_actions; // index: action, value: set of inverse actions
