...
protected:
    ...
    */
    ...
    // WARNING: only implemented for standard_scalar_open_list
    virtual void do_insertion(const ap_float &h, const Entry &entry) {}
...
public:
    ...
    */
    ...
    void insert(const ap_float &h, const Entry &entry);
    ...
    /*
      ...
      element there.
    */
    virtual Entry remove_min(std::vector<ap_float> *key = 0) = 0;
...
template<class Entry>
void OpenList<Entry>::insert(
    const ap_float &h, const Entry &entry) {
    // TODO preferred
