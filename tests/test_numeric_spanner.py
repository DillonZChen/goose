...
def test_domain(domain):
    ...
    train(domain, modelpath, predictor=PREDICTOR, benchmarks=BENCHMARKS)
    plan(domain, PROBLEM, modelpath, "nfd", expected_expanded_ub=EXPECTED_EXPANDED_UB, benchmarks=BENCHMARKS)
