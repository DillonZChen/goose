;; rows=3, columns=7, robots=3, out_folder=testing/easy, instance_id=21, seed=1027

(define (problem floortile-21)
 (:domain floortile)
 (:objects 
    tile_0_1
    tile_0_2
 ...
 (:init 
    (robot-at robot1 tile_3_2)
    (robot-has robot1 white)
    (robot-at robot2 tile_0_3)
    (robot-has robot2 black)
    (robot-at robot3 tile_2_5)
