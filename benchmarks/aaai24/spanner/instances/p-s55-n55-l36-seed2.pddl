(define (problem p-s55-n55-l36-seed2)
 ...
 (:init 
    ...
    (useable spanner24)
    (at spanner25 location28)
    (useable spanner25)
    (at spanner26 location34)
    (useable spanner26)
