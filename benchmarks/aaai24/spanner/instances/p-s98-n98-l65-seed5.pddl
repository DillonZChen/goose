(define (problem p-s98-n98-l65-seed5)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner81)
    (at spanner82 location60)
    (useable spanner82)
    (at spanner83 location14)
    (useable spanner83)
    (at spanner84 location48)
    (useable spanner84)
    (at spanner85 location38)
    (useable spanner85)
    (at spanner86 location5)
    (useable spanner86)
    (at spanner87 location56)
    (useable spanner87)
    (at spanner88 location12)
    (useable spanner88)
    ...
    (useable spanner91)
    (at spanner92 location19)
    (useable spanner92)
    (at spanner93 location44)
    (useable spanner93)
