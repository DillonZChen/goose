(define (problem p-s92-n92-l61-seed5)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner60)
    (at spanner61 location11)
    (useable spanner61)
    (at spanner62 location19)
    (useable spanner62)
    (at spanner63 location21)
    (useable spanner63)
    (at spanner64 location13)
    (useable spanner64)
    (at spanner65 location35)
    (useable spanner65)
    (at spanner66 location57)
    (useable spanner66)
    (at spanner67 location44)
    (useable spanner67)
    (at spanner68 location41)
    (useable spanner68)
    ...
    (useable spanner71)
    (at spanner72 location45)
    (useable spanner72)
    (at spanner73 location13)
    (useable spanner73)
    (at spanner74 location58)
    (useable spanner74)
    (at spanner75 location25)
    (useable spanner75)
    ...
    (useable spanner88)
    (at spanner89 location38)
    (useable spanner89)
    (at spanner90 location1)
    (useable spanner90)
    (at spanner91 location39)
    (useable spanner91)
    (at spanner92 location44)
    (useable spanner92)
    (loose nut1)
    (at nut1 gate)
    (loose nut2)
