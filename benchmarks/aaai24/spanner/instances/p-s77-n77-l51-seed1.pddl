(define (problem p-s77-n77-l51-seed1)
 ...
 (:init 
    ...
    (useable spanner9)
    (at spanner10 location31)
    (useable spanner10)
    (at spanner11 location42)
    (useable spanner11)
    (at spanner12 location25)
    (useable spanner12)
    ...
    (useable spanner15)
    (at spanner16 location32)
    (useable spanner16)
    (at spanner17 location2)
    (useable spanner17)
    (at spanner18 location25)
    (useable spanner18)
    ...
    (useable spanner23)
    (at spanner24 location45)
    (useable spanner24)
    (at spanner25 location29)
    (useable spanner25)
    ...
    (useable spanner35)
    (at spanner36 location35)
    (useable spanner36)
    (at spanner37 location1)
    (useable spanner37)
    (at spanner38 location25)
    (useable spanner38)
    (at spanner39 location44)
    (useable spanner39)
    (at spanner40 location14)
    (useable spanner40)
    (at spanner41 location28)
    (useable spanner41)
    (at spanner42 location47)
    (useable spanner42)
    (at spanner43 location2)
    (useable spanner43)
    (at spanner44 location34)
    (useable spanner44)
