(define (problem p-s69-n69-l46-seed3)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner59)
    (at spanner60 location27)
    (useable spanner60)
    (at spanner61 location33)
    (useable spanner61)
    (at spanner62 location25)
    (useable spanner62)
