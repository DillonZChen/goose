(define (problem p-s67-n67-l44-seed1)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner37)
    (at spanner38 location29)
    (useable spanner38)
    (at spanner39 location32)
    (useable spanner39)
    (at spanner40 location36)
    (useable spanner40)
    (at spanner41 location15)
    (useable spanner41)
    (at spanner42 location23)
    (useable spanner42)
    ...
    (useable spanner48)
    (at spanner49 location27)
    (useable spanner49)
    (at spanner50 location36)
    (useable spanner50)
    (at spanner51 location42)
    (useable spanner51)
