(define (problem p-s64-n64-l42-seed2)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner11)
    (at spanner12 location38)
    (useable spanner12)
    (at spanner13 location11)
    (useable spanner13)
    (at spanner14 location28)
    (useable spanner14)
    (at spanner15 location41)
    (useable spanner15)
    (at spanner16 location26)
    (useable spanner16)
    (at spanner17 location33)
    (useable spanner17)
    ...
    (useable spanner56)
    (at spanner57 location30)
    (useable spanner57)
    (at spanner58 location42)
    (useable spanner58)
