(define (problem p-s85-n85-l56-seed3)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner56)
    (at spanner57 location26)
    (useable spanner57)
    (at spanner58 location47)
    (useable spanner58)
    (at spanner59 location52)
    (useable spanner59)
    (at spanner60 location37)
    (useable spanner60)
    ...
    (useable spanner66)
    (at spanner67 location32)
    (useable spanner67)
    (at spanner68 location14)
    (useable spanner68)
    (at spanner69 location17)
    (useable spanner69)
    (at spanner70 location44)
    (useable spanner70)
    (at spanner71 location28)
    (useable spanner71)
    ...
    (useable spanner77)
    (at spanner78 location54)
    (useable spanner78)
    (at spanner79 location25)
    (useable spanner79)
    (at spanner80 location37)
    (useable spanner80)
