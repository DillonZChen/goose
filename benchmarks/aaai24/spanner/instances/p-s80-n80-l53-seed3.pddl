(define (problem p-s80-n80-l53-seed3)
 ...
 (:init 
    ...
    (useable spanner28)
    (at spanner29 location34)
    (useable spanner29)
    (at spanner30 location25)
    (useable spanner30)
    (at spanner31 location48)
    (useable spanner31)
    (at spanner32 location1)
    (useable spanner32)
    (at spanner33 location43)
    (useable spanner33)
    ...
    (useable spanner41)
    (at spanner42 location2)
    (useable spanner42)
    (at spanner43 location53)
    (useable spanner43)
    (at spanner44 location18)
    (useable spanner44)
    ...
    (useable spanner59)
    (at spanner60 location3)
    (useable spanner60)
    (at spanner61 location9)
    (useable spanner61)
    (at spanner62 location32)
    (useable spanner62)
    ...
    (useable spanner65)
    (at spanner66 location28)
    (useable spanner66)
    (at spanner67 location50)
    (useable spanner67)
    ...
    (useable spanner74)
    (at spanner75 location35)
    (useable spanner75)
    (at spanner76 location38)
    (useable spanner76)
    (at spanner77 location27)
    (useable spanner77)
    (at spanner78 location38)
    (useable spanner78)
