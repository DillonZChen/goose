(define (problem p-s91-n91-l60-seed1)
 ...
 (:init 
    ...
    (useable spanner64)
    (at spanner65 location60)
    (useable spanner65)
    (at spanner66 location2)
    (useable spanner66)
    (at spanner67 location27)
    (useable spanner67)
    (at spanner68 location54)
    (useable spanner68)
    (at spanner69 location59)
    (useable spanner69)
    (at spanner70 location36)
    (useable spanner70)
    (at spanner71 location60)
    (useable spanner71)
    (at spanner72 location42)
    (useable spanner72)
    (at spanner73 location7)
    (useable spanner73)
    (at spanner74 location12)
    (useable spanner74)
    (at spanner75 location41)
    (useable spanner75)
    (at spanner76 location47)
    (useable spanner76)
    (at spanner77 location56)
    (useable spanner77)
    (at spanner78 location19)
    (useable spanner78)
    (at spanner79 location8)
    (useable spanner79)
    (at spanner80 location48)
    (useable spanner80)
    (at spanner81 location22)
    (useable spanner81)
    (at spanner82 location58)
    (useable spanner82)
    (at spanner83 location47)
    (useable spanner83)
    (at spanner84 location46)
    (useable spanner84)
