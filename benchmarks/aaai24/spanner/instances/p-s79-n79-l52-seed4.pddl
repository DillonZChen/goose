(define (problem p-s79-n79-l52-seed4)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner27)
    (at spanner28 location42)
    (useable spanner28)
    (at spanner29 location52)
    (useable spanner29)
    ...
    (useable spanner39)
    (at spanner40 location6)
    (useable spanner40)
    (at spanner41 location39)
    (useable spanner41)
    (at spanner42 location22)
    (useable spanner42)
    (at spanner43 location43)
    (useable spanner43)
    ...
    (useable spanner53)
    (at spanner54 location1)
    (useable spanner54)
    (at spanner55 location19)
    (useable spanner55)
    (at spanner56 location37)
    (useable spanner56)
    (at spanner57 location46)
    (useable spanner57)
    (at spanner58 location20)
    (useable spanner58)
    ...
    (useable spanner71)
    (at spanner72 location52)
    (useable spanner72)
    (at spanner73 location3)
    (useable spanner73)
    (at spanner74 location6)
    (useable spanner74)
    (at spanner75 location3)
    (useable spanner75)
    (at spanner76 location30)
    (useable spanner76)
    (at spanner77 location41)
    (useable spanner77)
