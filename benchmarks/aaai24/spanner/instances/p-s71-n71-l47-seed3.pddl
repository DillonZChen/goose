(define (problem p-s71-n71-l47-seed3)
 ...
 (:init 
    ...
    (useable spanner31)
    (at spanner32 location43)
    (useable spanner32)
    (at spanner33 location5)
    (useable spanner33)
    (at spanner34 location11)
    (useable spanner34)
    (at spanner35 location38)
    (useable spanner35)
    ...
    (useable spanner38)
    (at spanner39 location18)
    (useable spanner39)
    (at spanner40 location31)
    (useable spanner40)
    ...
    (useable spanner56)
    (at spanner57 location17)
    (useable spanner57)
    (at spanner58 location44)
    (useable spanner58)
    (at spanner59 location28)
    (useable spanner59)
    (at spanner60 location41)
    (useable spanner60)
