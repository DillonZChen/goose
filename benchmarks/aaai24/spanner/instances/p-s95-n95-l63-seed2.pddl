(define (problem p-s95-n95-l63-seed2)
 ...
 (:init 
    ...
    (useable spanner84)
    (at spanner85 location62)
    (useable spanner85)
    (at spanner86 location29)
    (useable spanner86)
    (at spanner87 location11)
    (useable spanner87)
    (at spanner88 location62)
    (useable spanner88)
    ...
    (useable spanner92)
    (at spanner93 location30)
    (useable spanner93)
    (at spanner94 location42)
    (useable spanner94)
    (at spanner95 location34)
    (useable spanner95)
    (loose nut1)
    (at nut1 gate)
    (loose nut2)
