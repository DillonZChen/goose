(define (problem p-s85-n85-l56-seed4)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner60)
    (at spanner61 location54)
    (useable spanner61)
    (at spanner62 location20)
    (useable spanner62)
    (at spanner63 location1)
    (useable spanner63)
    ...
    (useable spanner66)
    (at spanner67 location20)
    (useable spanner67)
    (at spanner68 location55)
    (useable spanner68)
    (at spanner69 location49)
    (useable spanner69)
    (at spanner70 location33)
    (useable spanner70)
    (at spanner71 location13)
    (useable spanner71)
    (at spanner72 location27)
    (useable spanner72)
    (at spanner73 location28)
    (useable spanner73)
    (at spanner74 location39)
    (useable spanner74)
