(define (problem p-s77-n77-l51-seed2)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner5)
    (at spanner6 location48)
    (useable spanner6)
    (at spanner7 location43)
    (useable spanner7)
    ...
    (useable spanner16)
    (at spanner17 location28)
    (useable spanner17)
    (at spanner18 location41)
    (useable spanner18)
    ...
    (useable spanner23)
    (at spanner24 location29)
    (useable spanner24)
    (at spanner25 location33)
    (useable spanner25)
    ...
    (useable spanner54)
    (at spanner55 location48)
    (useable spanner55)
    (at spanner56 location34)
    (useable spanner56)
    (at spanner57 location49)
    (useable spanner57)
