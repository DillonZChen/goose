(define (problem p-s81-n81-l54-seed4)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner44)
    (at spanner45 location43)
    (useable spanner45)
    (at spanner46 location25)
    (useable spanner46)
    (at spanner47 location33)
    (useable spanner47)
    (at spanner48 location16)
    (useable spanner48)
    (at spanner49 location12)
    (useable spanner49)
    (at spanner50 location16)
    (useable spanner50)
    (at spanner51 location31)
    (useable spanner51)
    (at spanner52 location18)
    (useable spanner52)
    (at spanner53 location6)
    (useable spanner53)
    (at spanner54 location53)
    (useable spanner54)
