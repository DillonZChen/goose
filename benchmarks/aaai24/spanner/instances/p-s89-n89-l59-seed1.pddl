(define (problem p-s89-n89-l59-seed1)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner67)
    (at spanner68 location59)
    (useable spanner68)
    (at spanner69 location36)
    (useable spanner69)
    (at spanner70 location42)
    (useable spanner70)
    (at spanner71 location7)
    (useable spanner71)
    (at spanner72 location12)
    (useable spanner72)
    (at spanner73 location41)
    (useable spanner73)
    (at spanner74 location47)
    (useable spanner74)
    (at spanner75 location56)
    (useable spanner75)
    (at spanner76 location19)
    (useable spanner76)
    (at spanner77 location8)
    (useable spanner77)
    (at spanner78 location48)
    (useable spanner78)
    (at spanner79 location22)
    (useable spanner79)
    (at spanner80 location58)
    (useable spanner80)
    ...
    (useable spanner83)
    (at spanner84 location28)
    (useable spanner84)
    (at spanner85 location33)
    (useable spanner85)
    (at spanner86 location54)
    (useable spanner86)
    (at spanner87 location59)
    (useable spanner87)
    (at spanner88 location43)
    (useable spanner88)
