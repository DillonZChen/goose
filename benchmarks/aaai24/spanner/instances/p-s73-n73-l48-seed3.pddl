(define (problem p-s73-n73-l48-seed3)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner46)
    (at spanner47 location26)
    (useable spanner47)
    (at spanner48 location47)
    (useable spanner48)
    (at spanner49 location37)
    (useable spanner49)
    ...
    (useable spanner57)
    (at spanner58 location17)
    (useable spanner58)
    (at spanner59 location44)
    (useable spanner59)
    (at spanner60 location28)
    (useable spanner60)
    (at spanner61 location41)
    (useable spanner61)
    ...
    (useable spanner64)
    (at spanner65 location25)
    (useable spanner65)
    (at spanner66 location37)
    (useable spanner66)
    (at spanner67 location23)
    (useable spanner67)
    (at spanner68 location35)
    (useable spanner68)
