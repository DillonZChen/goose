(define (problem p-s73-n73-l48-seed1)
 ...
 (:init 
    ...
    (useable spanner18)
    (at spanner19 location45)
    (useable spanner19)
    (at spanner20 location29)
    (useable spanner20)
    ...
    (useable spanner23)
    (at spanner24 location38)
    (useable spanner24)
    (at spanner25 location7)
    (useable spanner25)
    (at spanner26 location21)
    (useable spanner26)
    ...
    (useable spanner39)
    (at spanner40 location15)
    (useable spanner40)
    (at spanner41 location29)
    (useable spanner41)
    (at spanner42 location32)
    (useable spanner42)
    (at spanner43 location36)
    (useable spanner43)
