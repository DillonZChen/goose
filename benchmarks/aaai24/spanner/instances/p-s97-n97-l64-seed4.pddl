(define (problem p-s97-n97-l64-seed4)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner33)
    (at spanner34 location61)
    (useable spanner34)
    (at spanner35 location36)
    (useable spanner35)
    (at spanner36 location12)
    (useable spanner36)
    (at spanner37 location39)
    (useable spanner37)
    (at spanner38 location1)
    (useable spanner38)
    (at spanner39 location38)
    (useable spanner39)
    (at spanner40 location40)
    (useable spanner40)
    (at spanner41 location25)
    (useable spanner41)
    (at spanner42 location53)
    (useable spanner42)
    (at spanner43 location55)
    (useable spanner43)
    (at spanner44 location37)
    (useable spanner44)
    (at spanner45 location56)
    (useable spanner45)
    (at spanner46 location58)
    (useable spanner46)
    (at spanner47 location21)
    (useable spanner47)
    (at spanner48 location30)
    (useable spanner48)
    ...
    (useable spanner94)
    (at spanner95 location25)
    (useable spanner95)
    (at spanner96 location57)
    (useable spanner96)
    (at spanner97 location38)
    (useable spanner97)
    (loose nut1)
    (at nut1 gate)
    (loose nut2)
