(define (problem p-s71-n71-l47-seed5)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner50)
    (at spanner51 location45)
    (useable spanner51)
    (at spanner52 location13)
    (useable spanner52)
    (at spanner53 location25)
    (useable spanner53)
    (at spanner54 location20)
    (useable spanner54)
    (at spanner55 location2)
    (useable spanner55)
    ...
    (useable spanner66)
    (at spanner67 location39)
    (useable spanner67)
    (at spanner68 location44)
    (useable spanner68)
