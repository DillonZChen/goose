(define (problem p-s83-n83-l55-seed4)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner39)
    (at spanner40 location47)
    (useable spanner40)
    (at spanner41 location55)
    (useable spanner41)
    ...
    (useable spanner45)
    (at spanner46 location39)
    (useable spanner46)
    (at spanner47 location22)
    (useable spanner47)
    ...
    (useable spanner55)
    (at spanner56 location6)
    (useable spanner56)
    (at spanner57 location53)
    (useable spanner57)
    (at spanner58 location36)
    (useable spanner58)
    (at spanner59 location54)
    (useable spanner59)
    (at spanner60 location20)
    (useable spanner60)
    (at spanner61 location1)
    (useable spanner61)
    (at spanner62 location19)
    (useable spanner62)
    (at spanner63 location37)
    (useable spanner63)
    ...
    (useable spanner71)
    (at spanner72 location39)
    (useable spanner72)
    (at spanner73 location19)
    (useable spanner73)
    (at spanner74 location28)
    (useable spanner74)
    (at spanner75 location29)
    (useable spanner75)
    (at spanner76 location11)
    (useable spanner76)
    (at spanner77 location15)
    (useable spanner77)
