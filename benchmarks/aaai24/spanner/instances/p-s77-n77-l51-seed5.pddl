(define (problem p-s77-n77-l51-seed5)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner49)
    (at spanner50 location19)
    (useable spanner50)
    (at spanner51 location21)
    (useable spanner51)
    (at spanner52 location13)
    (useable spanner52)
    ...
    (useable spanner57)
    (at spanner58 location45)
    (useable spanner58)
    (at spanner59 location13)
    (useable spanner59)
    (at spanner60 location25)
    (useable spanner60)
    (at spanner61 location20)
    (useable spanner61)
