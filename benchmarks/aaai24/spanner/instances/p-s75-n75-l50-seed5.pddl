(define (problem p-s75-n75-l50-seed5)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner16)
    (at spanner17 location24)
    (useable spanner17)
    (at spanner18 location31)
    (useable spanner18)
    (at spanner19 location16)
    (useable spanner19)
    ...
    (useable spanner27)
    (at spanner28 location27)
    (useable spanner28)
    (at spanner29 location18)
    (useable spanner29)
    (at spanner30 location12)
    (useable spanner30)
    (at spanner31 location50)
    (useable spanner31)
    (at spanner32 location25)
    (useable spanner32)
    (at spanner33 location11)
    (useable spanner33)
    (at spanner34 location49)
    (useable spanner34)
