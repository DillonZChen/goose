(define (problem p-s85-n85-l56-seed5)
 ...
 (:init 
    ...
    (useable spanner60)
    (at spanner61 location44)
    (useable spanner61)
    (at spanner62 location41)
    (useable spanner62)
    (at spanner63 location14)
    (useable spanner63)
    (at spanner64 location12)
    (useable spanner64)
    ...
    (useable spanner67)
    (at spanner68 location20)
    (useable spanner68)
    (at spanner69 location2)
    (useable spanner69)
    (at spanner70 location24)
    (useable spanner70)
    (at spanner71 location27)
    (useable spanner71)
    (at spanner72 location11)
    (useable spanner72)
    (at spanner73 location10)
    (useable spanner73)
    ...
    (useable spanner77)
    (at spanner78 location53)
    (useable spanner78)
    (at spanner79 location39)
    (useable spanner79)
    (at spanner80 location38)
    (useable spanner80)
    (at spanner81 location1)
    (useable spanner81)
    (at spanner82 location39)
    (useable spanner82)
    (at spanner83 location44)
    (useable spanner83)
