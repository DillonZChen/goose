(define (problem p-s80-n80-l53-seed5)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner7)
    (at spanner8 location42)
    (useable spanner8)
    (at spanner9 location34)
    (useable spanner9)
    (at spanner10 location2)
    (useable spanner10)
    (at spanner11 location30)
    (useable spanner11)
    (at spanner12 location50)
    (useable spanner12)
    (at spanner13 location16)
    (useable spanner13)
    (at spanner14 location42)
    (useable spanner14)
    (at spanner15 location4)
    (useable spanner15)
    (at spanner16 location11)
    (useable spanner16)
    (at spanner17 location8)
    (useable spanner17)
    ...
    (useable spanner49)
    (at spanner50 location11)
    (useable spanner50)
    (at spanner51 location19)
    (useable spanner51)
    (at spanner52 location21)
    (useable spanner52)
    (at spanner53 location13)
    (useable spanner53)
    (at spanner54 location35)
    (useable spanner54)
    (at spanner55 location44)
    (useable spanner55)
    (at spanner56 location41)
    (useable spanner56)
