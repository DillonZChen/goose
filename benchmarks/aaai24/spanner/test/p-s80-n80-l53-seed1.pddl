(define (problem p-s80-n80-l53-seed1)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner19)
    (at spanner20 location28)
    (useable spanner20)
    (at spanner21 location39)
    (useable spanner21)
    ...
    (useable spanner25)
    (at spanner26 location29)
    (useable spanner26)
    (at spanner27 location18)
    (useable spanner27)
    (at spanner28 location47)
    (useable spanner28)
    (at spanner29 location52)
    (useable spanner29)
    (at spanner30 location15)
    (useable spanner30)
    (at spanner31 location38)
    (useable spanner31)
