(define (problem p-s95-n95-l63-seed5)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner55)
    (at spanner56 location1)
    (useable spanner56)
    (at spanner57 location14)
    (useable spanner57)
    (at spanner58 location50)
    (useable spanner58)
    (at spanner59 location14)
    (useable spanner59)
    (at spanner60 location62)
    (useable spanner60)
    (at spanner61 location63)
    (useable spanner61)
    (at spanner62 location11)
    (useable spanner62)
    (at spanner63 location56)
    (useable spanner63)
    (at spanner64 location11)
    (useable spanner64)
    ...
    (useable spanner74)
    (at spanner75 location61)
    (useable spanner75)
    (at spanner76 location62)
    (useable spanner76)
    (at spanner77 location45)
    (useable spanner77)
    (at spanner78 location13)
    (useable spanner78)
    (at spanner79 location62)
    (useable spanner79)
    (at spanner80 location62)
    (useable spanner80)
    (at spanner81 location58)
    (useable spanner81)
    (at spanner82 location25)
    (useable spanner82)
    (at spanner83 location20)
    (useable spanner83)
    (at spanner84 location2)
    (useable spanner84)
    (at spanner85 location24)
    (useable spanner85)
