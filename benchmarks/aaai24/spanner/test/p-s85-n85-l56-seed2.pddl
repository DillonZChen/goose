(define (problem p-s85-n85-l56-seed2)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner43)
    (at spanner44 location36)
    (useable spanner44)
    (at spanner45 location12)
    (useable spanner45)
    (at spanner46 location16)
    (useable spanner46)
    (at spanner47 location15)
    (useable spanner47)
    ...
    (useable spanner54)
    (at spanner55 location24)
    (useable spanner55)
    (at spanner56 location33)
    (useable spanner56)
    (at spanner57 location44)
    (useable spanner57)
    (at spanner58 location36)
    (useable spanner58)
    ...
    (useable spanner62)
    (at spanner63 location48)
    (useable spanner63)
    (at spanner64 location34)
    (useable spanner64)
    ...
    (useable spanner67)
    (at spanner68 location38)
    (useable spanner68)
    (at spanner69 location23)
    (useable spanner69)
    (at spanner70 location24)
    (useable spanner70)
    (at spanner71 location55)
    (useable spanner71)
    (at spanner72 location29)
    (useable spanner72)
    ...
    (useable spanner80)
    (at spanner81 location16)
    (useable spanner81)
    (at spanner82 location32)
    (useable spanner82)
    (at spanner83 location18)
    (useable spanner83)
    (at spanner84 location32)
    (useable spanner84)
