;; spanners=30, nuts=15, locations=15, out_folder=testing/medium, instance_id=1, seed=1007
...
(define (problem spanner-01)
 ...
 (:objects 
    ...
    shed location1 location2 location3 location4 location5 location6 location7 location8 location9 location10 location11 location12 location13 location14 location15 gate - location
 )
 (:init 
    (at bob shed)
