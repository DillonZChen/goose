...
(define (problem childsnack-25)
 ...
 (:init 
    ...
    (waiting child87 table2)
    (waiting child155 table3)
    (waiting child232 table1)
    (waiting child20 table1)
    (waiting child227 table3)
