;; satellites=34, instruments=65, modes=5, directions=27, out_folder=testing/medium, instance_id=24, seed=1030
...
(define (problem satellite-24)
 ...
 (:init 
    ...
    (calibration_target ins23 dir25)
    ...
    (on_board ins59 sat7)
    (on_board ins60 sat1)
    (on_board ins61 sat15)
    (on_board ins62 sat3)
    (on_board ins63 sat19)
    (on_board ins64 sat33)
    (on_board ins65 sat21)
    (supports ins9 mod4)
    (supports ins61 mod3)
    (supports ins7 mod4)
    (supports ins30 mod5)
 ...
 (:goal  (and (pointing sat2 dir1)
   ...
   (pointing sat20 dir24)
   (pointing sat26 dir2)
   (pointing sat27 dir18)
