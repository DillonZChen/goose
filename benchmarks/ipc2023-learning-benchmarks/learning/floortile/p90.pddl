;; rows=5, columns=6, robots=3, out_folder=training/easy, instance_id=90, seed=115

(define (problem floortile-90)
 (:domain floortile)
 (:objects 
    tile_0_1
    tile_0_2
 ...
 (:init 
    (robot-at robot1 tile_2_5)
    (robot-has robot1 black)
    (robot-at robot2 tile_5_4)
    (robot-has robot2 black)
    (robot-at robot3 tile_5_6)
