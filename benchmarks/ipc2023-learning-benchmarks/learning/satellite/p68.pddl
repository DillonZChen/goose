;; satellites=8, instruments=14, modes=2, directions=8, out_folder=training/easy, instance_id=68, seed=101

(define (problem satellite-68)
 (:domain satellite)
 (:objects 
