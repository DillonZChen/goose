;; satellites=9, instruments=17, modes=3, directions=9, out_folder=training/easy, instance_id=83, seed=116

(define (problem satellite-83)
 (:domain satellite)
 (:objects 
