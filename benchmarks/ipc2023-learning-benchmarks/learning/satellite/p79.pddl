;; satellites=9, instruments=16, modes=3, directions=9, out_folder=training/easy, instance_id=79, seed=112

(define (problem satellite-79)
 (:domain satellite)
 (:objects 
