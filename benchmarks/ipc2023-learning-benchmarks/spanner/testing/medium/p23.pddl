...
(define (problem spanner-23)
 ...
 (:init 
    ...
    (usable spanner9)
    (at spanner10 location23)
    (usable spanner10)
    (at spanner11 location7)
    (usable spanner11)
    (at spanner12 location18)
    (usable spanner12)
    (at spanner13 location24)
    (usable spanner13)
    (at spanner14 location18)
    (usable spanner14)
    (at spanner15 location27)
    (usable spanner15)
    ...
    (usable spanner42)
    (at spanner43 location23)
    (usable spanner43)
    (at spanner44 location5)
    (usable spanner44)
    (at spanner45 location35)
    (usable spanner45)
    ...
    (usable spanner52)
    (at spanner53 location4)
    (usable spanner53)
    (at spanner54 location2)
    (usable spanner54)
    (at spanner55 location34)
    (usable spanner55)
    (at spanner56 location34)
    (usable spanner56)
    (at spanner57 location4)
    (usable spanner57)
