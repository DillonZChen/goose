;; spanners=60, nuts=33, locations=30, out_folder=testing/medium, instance_id=16, seed=1022
...
(define (problem spanner-16)
 ...
 (:init 
    ...
    (usable spanner7)
    (at spanner8 location13)
    (usable spanner8)
    (at spanner9 location18)
    (usable spanner9)
    (at spanner10 location22)
    (usable spanner10)
    (at spanner11 location22)
    (usable spanner11)
