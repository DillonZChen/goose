;; spanners=72, nuts=40, locations=36, out_folder=testing/medium, instance_id=22, seed=1028
...
(define (problem spanner-22)
 ...
 (:objects 
    ...
    nut1 nut2 nut3 nut4 nut5 nut6 nut7 nut8 nut9 nut10 nut11 nut12 nut13 nut14 nut15 nut16 nut17 nut18 nut19 nut20 nut21 nut22 nut23 nut24 nut25 nut26 nut27 nut28 nut29 nut30 nut31 nut32 nut33 nut34 nut35 nut36 nut37 nut38 nut39 nut40 - nut
    shed location1 location2 location3 location4 location5 location6 location7 location8 location9 location10 location11 location12 location13 location14 location15 location16 location17 location18 location19 location20 location21 location22 location23 location24 location25 location26 location27 location28 location29 location30 location31 location32 location33 location34 location35 location36 gate - location
 )
 (:init 
    (at bob shed)
    (at spanner1 location30)
    (usable spanner1)
    (at spanner2 location26)
    (usable spanner2)
    (at spanner3 location17)
    (usable spanner3)
    (at spanner4 location13)
    (usable spanner4)
    (at spanner5 location30)
    (usable spanner5)
    (at spanner6 location23)
    (usable spanner6)
    (at spanner7 location35)
    (usable spanner7)
    ...
    (usable spanner20)
    (at spanner21 location23)
    (usable spanner21)
    (at spanner22 location28)
    (usable spanner22)
    (at spanner23 location15)
    (usable spanner23)
    (at spanner24 location34)
    (usable spanner24)
    (at spanner25 location10)
    (usable spanner25)
    (at spanner26 location20)
    (usable spanner26)
    ...
    (usable spanner36)
    (at spanner37 location35)
    (usable spanner37)
    (at spanner38 location6)
    (usable spanner38)
    (at spanner39 location28)
    (usable spanner39)
    (at spanner40 location10)
    (usable spanner40)
    (at spanner41 location18)
    (usable spanner41)
    (at spanner42 location9)
    (usable spanner42)
    (at spanner43 location31)
    (usable spanner43)
    (at spanner44 location12)
    (usable spanner44)
    (at spanner45 location4)
    (usable spanner45)
