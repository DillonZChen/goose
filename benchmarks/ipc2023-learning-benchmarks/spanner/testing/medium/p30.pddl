;; spanners=88, nuts=49, locations=44, out_folder=testing/medium, instance_id=30, seed=1036
...
(define (problem spanner-30)
 ...
 (:init 
    ...
    (usable spanner15)
    (at spanner16 location33)
    (usable spanner16)
    (at spanner17 location17)
    (usable spanner17)
    (at spanner18 location31)
    (usable spanner18)
    ...
    (usable spanner67)
    (at spanner68 location26)
    (usable spanner68)
    (at spanner69 location14)
    (usable spanner69)
    (at spanner70 location38)
    (usable spanner70)
    (at spanner71 location21)
    (usable spanner71)
    (at spanner72 location1)
    (usable spanner72)
    ...
    (usable spanner75)
    (at spanner76 location21)
    (usable spanner76)
    (at spanner77 location10)
    (usable spanner77)
    (at spanner78 location6)
    (usable spanner78)
