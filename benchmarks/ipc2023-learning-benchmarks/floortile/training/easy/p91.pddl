;; rows=5, columns=6, robots=3, out_folder=training/easy, instance_id=91, seed=116

(define (problem floortile-91)
 (:domain floortile)
 (:objects 
    tile_0_1
    tile_0_2
 ...
 (:init 
    (robot-at robot1 tile_5_2)
    (robot-has robot1 white)
    (robot-at robot2 tile_3_4)
    (robot-has robot2 black)
    (robot-at robot3 tile_1_1)
