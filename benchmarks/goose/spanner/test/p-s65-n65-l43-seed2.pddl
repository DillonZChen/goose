(define (problem p-s65-n65-l43-seed2)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner31)
    (at spanner32 location11)
    (useable spanner32)
    (at spanner33 location36)
    (useable spanner33)
    (at spanner34 location12)
    (useable spanner34)
    (at spanner35 location16)
    (useable spanner35)
    ...
    (useable spanner51)
    (at spanner52 location38)
    (useable spanner52)
    (at spanner53 location23)
    (useable spanner53)
    (at spanner54 location24)
    (useable spanner54)
