(define (problem p-s79-n79-l52-seed3)
 ...
 (:init 
    ...
    (useable spanner56)
    (at spanner57 location24)
    (useable spanner57)
    (at spanner58 location7)
    (useable spanner58)
    (at spanner59 location3)
    (useable spanner59)
    (at spanner60 location9)
    (useable spanner60)
    (at spanner61 location32)
    (useable spanner61)
    (at spanner62 location14)
    (useable spanner62)
    (at spanner63 location17)
    (useable spanner63)
