(define (problem p-s77-n77-l51-seed4)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner20)
    (at spanner21 location50)
    (useable spanner21)
    (at spanner22 location12)
    (useable spanner22)
    ...
    (useable spanner34)
    (at spanner35 location47)
    (useable spanner35)
    (at spanner36 location24)
    (useable spanner36)
    (at spanner37 location6)
    (useable spanner37)
    ...
    (useable spanner45)
    (at spanner46 location31)
    (useable spanner46)
    (at spanner47 location18)
    (useable spanner47)
    (at spanner48 location6)
    (useable spanner48)
    (at spanner49 location36)
    (useable spanner49)
    (at spanner50 location20)
    (useable spanner50)
