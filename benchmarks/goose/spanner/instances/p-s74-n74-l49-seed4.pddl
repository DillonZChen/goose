(define (problem p-s74-n74-l49-seed4)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner25)
    (at spanner26 location42)
    (useable spanner26)
    (at spanner27 location17)
    (useable spanner27)
    (at spanner28 location18)
    (useable spanner28)
    (at spanner29 location13)
    (useable spanner29)
    ...
    (useable spanner32)
    (at spanner33 location41)
    (useable spanner33)
    (at spanner34 location47)
    (useable spanner34)
    (at spanner35 location24)
    (useable spanner35)
    (at spanner36 location6)
    (useable spanner36)
    (at spanner37 location39)
    (useable spanner37)
    (at spanner38 location22)
    (useable spanner38)
