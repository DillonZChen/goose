;; satellites=30, instruments=54, modes=4, directions=24, out_folder=testing/medium, instance_id=19, seed=1025
...
(define (problem satellite-19)
 ...
 (:init 
    ...
    (calibration_target ins17 dir22)
    ...
    (calibration_target ins51 dir10)
    (calibration_target ins52 dir3)
    (calibration_target ins53 dir7)
    (calibration_target ins54 dir5)
    (on_board ins1 sat26)
    (on_board ins2 sat10)
    (on_board ins3 sat4)
    (on_board ins4 sat3)
    ...
    (on_board ins15 sat22)
    (on_board ins16 sat28)
    (on_board ins17 sat18)
    (on_board ins18 sat13)
    (on_board ins19 sat5)
    (on_board ins20 sat12)
    (on_board ins21 sat7)
    ...
    (on_board ins36 sat30)
    (on_board ins37 sat14)
    (on_board ins38 sat5)
    (on_board ins39 sat18)
