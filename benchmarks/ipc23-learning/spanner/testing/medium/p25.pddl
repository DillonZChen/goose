;; spanners=78, nuts=43, locations=39, out_folder=testing/medium, instance_id=25, seed=1031
...
(define (problem spanner-25)
 ...
 (:objects 
    ...
    nut1 nut2 nut3 nut4 nut5 nut6 nut7 nut8 nut9 nut10 nut11 nut12 nut13 nut14 nut15 nut16 nut17 nut18 nut19 nut20 nut21 nut22 nut23 nut24 nut25 nut26 nut27 nut28 nut29 nut30 nut31 nut32 nut33 nut34 nut35 nut36 nut37 nut38 nut39 nut40 nut41 nut42 nut43 - nut
 ...
 (:init 
    ...
    (usable spanner15)
    (at spanner16 location12)
    (usable spanner16)
    (at spanner17 location1)
    (usable spanner17)
    (at spanner18 location12)
    (usable spanner18)
    (at spanner19 location13)
    (usable spanner19)
    ...
    (usable spanner29)
    (at spanner30 location34)
    (usable spanner30)
    (at spanner31 location7)
    (usable spanner31)
    (at spanner32 location37)
    (usable spanner32)
    (at spanner33 location31)
    (usable spanner33)
