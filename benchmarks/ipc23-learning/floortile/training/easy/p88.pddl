;; rows=3, columns=10, robots=3, out_folder=training/easy, instance_id=88, seed=113

(define (problem floortile-88)
 (:domain floortile)
 (:objects 
    tile_0_1
    tile_0_2
 ...
 (:init 
    (robot-at robot1 tile_0_6)
    (robot-has robot1 black)
    (robot-at robot2 tile_1_8)
