...
def main():
    ...
    for c_dir, n_dir in [
        ...
        for f_name in tqdm(sorted(os.listdir(c_dir))):
            ...
            people = [obj for obj in problem.all_objects if str(obj.type) == "passenger"]

            """""" """""" """""" """""" """""" """""" """""" """""" """""" """"""
            """""" """""" """ actual problem writing starts here """ """""" """"""
            """""" """""" """""" """""" """""" """""" """""" """""" """""" """"""

            problem.set_initial_value(fluents["load"], 0)
            for person in people:
                weight = random.randint(1, 3)
                problem.set_initial_value(fluents["weight"](person), weight)
