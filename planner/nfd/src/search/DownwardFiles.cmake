...
fast_downward_plugin(
    NAME EAGER_SEARCH
    HELP "Eager search algorithms + algorithms for NGOOSE"
    SOURCES
        search_engines/eager_search.cc
        search_engines/batch_eager_search.cc
        search_engines/wlf_mq_eager_search.cc
        search_engines/pref_schema_search.cc
...
fast_downward_plugin(
    NAME PERFECT_SEARCH
    HELP "Print states from plan"
    SOURCES
        search_engines/perfect.cc
        search_engines/plan_trace_successors.cc
    DEPENDS SEARCH_COMMON
)
...
fast_downward_plugin(
    NAME NGOOSE_HEURISTIC
    HELP "Files for numeric GOOSE heuristics"
    SOURCES
        ngoose/pybind_heuristic.cc
        ngoose/gnn_py_heuristic.cc
        ngoose/gnn_heuristic.cc
        ngoose/gnn_graph.cc
        ngoose/wlf_py_heuristic.cc
        ngoose/wlf_heuristic.cc
        ngoose/wlf_graph.cc
        ngoose/lrnn_heuristic.cc
)
...
fast_downward_plugin(
    ...
    SOURCES
        ...
        tasks/root_task.cc
        tasks/explicit_task.cc
        tasks/transition_normal_form_task.cc
    CORE_PLUGIN
)
