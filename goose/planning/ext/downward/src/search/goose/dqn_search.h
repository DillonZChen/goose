#ifndef GOOSE_DUAL_QUEUE_NOVELTY_SEARCH_H
#define GOOSE_DUAL_QUEUE_NOVELTY_SEARCH_H
...
class DualQueueEagerSearch : public SearchAlgorithm {
...
extern void add_dqn_search_options_to_feature(
