(define (problem p-s75-n75-l50-seed1)
 ...
 (:init 
    ...
    (useable spanner33)
    (at spanner34 location42)
    (useable spanner34)
    (at spanner35 location35)
    (useable spanner35)
