(define (problem p-s62-n62-l41-seed5)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner19)
    (at spanner20 location14)
    (useable spanner20)
    (at spanner21 location27)
    (useable spanner21)
    ...
    (useable spanner27)
    (at spanner28 location40)
    (useable spanner28)
    (at spanner29 location40)
    (useable spanner29)
    (at spanner30 location29)
    (useable spanner30)
    (at spanner31 location9)
    (useable spanner31)
    (at spanner32 location9)
    (useable spanner32)
    ...
    (useable spanner52)
    (at spanner53 location10)
    (useable spanner53)
    (at spanner54 location17)
    (useable spanner54)
    (at spanner55 location5)
    (useable spanner55)
    (at spanner56 location22)
    (useable spanner56)
