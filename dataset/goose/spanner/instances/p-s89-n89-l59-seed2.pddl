(define (problem p-s89-n89-l59-seed2)
 (:domain spanner)
 (:objects 
     bob - man
 ...
 (:init 
    ...
    (useable spanner46)
    (at spanner47 location11)
    (useable spanner47)
    (at spanner48 location36)
    (useable spanner48)
    (at spanner49 location12)
    (useable spanner49)
    (at spanner50 location16)
    (useable spanner50)
    ...
    (useable spanner62)
    (at spanner63 location12)
    (useable spanner63)
    (at spanner64 location58)
    (useable spanner64)
    ...
    (useable spanner69)
    (at spanner70 location59)
    (useable spanner70)
    (at spanner71 location59)
    (useable spanner71)
    (at spanner72 location49)
    (useable spanner72)
